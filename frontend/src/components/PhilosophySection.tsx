...
export default function PhilosophySection() {
  ...
  return (
    <section className="bg-black py-28 md:py-40 px-6 overflow-hidden max-w-6xl mx-auto" ref={ref}>
      <motion.h2
      ...
      >
        Innovation <em className="font-['Instrument_Serif'] italic text-white/40">x</em> Vision
      </motion.h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 overflow-hidden">
        <motion.div
